...
echo "[INFO] Tests run: 4, Failures: 0, Errors: 1, Skipped: 0, Time elapsed: 7.16 s - in com.github.noraui.browser.AuthUT" >> nonaui.log
echo "[INFO] Tests run: 35, Failures: 0, Errors: 2, Skipped: 0, Time elapsed: 7.45 s - in com.github.noraui.browser.FooUT" >> nonaui.log
